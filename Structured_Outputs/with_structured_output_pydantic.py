...
class ProductReview(BaseModel):
    ...
    pros: Optional[list[str]] = Field(description="write down all the pros mentioned in the review in a list")
    cons: Optional[list[str]] = Field(description="write down all the cons mentioned in the review in a list")


structured_model2 = model.with_structured_output(ProductReview)
